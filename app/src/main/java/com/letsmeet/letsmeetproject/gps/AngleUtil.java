...
public class AngleUtil {
    ...
    public static double getAngle(double longitudeA, double latitudeA, double longitudeB, double latitudeB){
        MyLatLng A=new MyLatLng(longitudeA,latitudeA);
        MyLatLng B=new MyLatLng(longitudeB,latitudeB);
        double result = getAngle(A,B);
        return result;
    }
